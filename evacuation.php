...
$sql = "SELECT * FROM evacuations ORDER BY id ASC";
...
<body>
	...
	<nav>
			...
			<a href="#" class="nav-link">Evacuation Center</a>
			<?php
$id = $user['id'];
	...
	<span class="badge bg-danger" id="counts" style="color:white;  border-radius: 60%;position: relative;top: -10px;left: -7px;font-size: 8px;"><?php echo $count['total']; ?></span>
		...
		<main>
			<div class="head-title">
				<div class="left">
				<h1 style="font-size:20px;">Evacuation Center</h1>
...
@media screen and (max-width: 576px) {
	...
	#content main .table-data .center table tbody{
		min-width: 20px;
        font-size: 8px;
	}
