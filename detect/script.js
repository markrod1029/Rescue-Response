    ...
    function onSuccess(position){
        ...
        let {latitude, longitude, apiKey ="25d554c0cc2a452290b0b8961f4cf55b"} = position.coords; //getting latitude and longitude properties value from coords obj
        ...
        .then(response => response.json()).then(response =>{
            ...
            let { village, _category, county, postcode, country} = allDetails; //getting country, postcode, country properties value from allDetails obj
            button.innerText = `${village}, ${_category}, ${county} ${postcode}, ${country}`; 
            document.getElementById("input").value = `${village}, ${_category}, ${county} ${postcode}, ${country}`; 
