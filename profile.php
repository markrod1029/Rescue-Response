		...
		<main>
            ...
            <div class="table-data">
				<div class="center" style="align-items;center">
                        ...
                        <div class="details">
                           <a href="profile.php" class="active">Profile</a>&nbsp;&nbsp;&nbsp;<a href="security.php">Security Setting</a>
                            <div class="content">
                            <form action="CRUD/update_profile.php?ID=<?php echo $user['id'];?>" method="post" class="form" enctype="multipart/form-data">  
                                    ...
                                    <div class="input-box">
                						...
                						<input type="text" name="contactnum"  minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  placeholder="Phone Number" data-mdb-input-mask="+63 0000-000-0000" value="<?php echo $user['contactnum'];?>"> 
										
                                    </div>
                                    <div class="input-box">
                                        <label>Email</label>
                                        <input type="text" name="user" id="user" value="<?php echo $user['user'];?>">
                                    </div>
                                    ...
                                    <button class="save" name="save">Update</button>
                                  </form>
                            </div>
                        </div>
