...
//   $time = $_POST['time'];
  ...
  $others = htmlspecialchars( $_POST['others'], ENT_QUOTES, 'UTF-8');
    $victim_names = htmlspecialchars( $_POST['victim_names'], ENT_QUOTES, 'UTF-8');
  $id = $_GET['user'];
    $location_id = $_GET['ID'];
...
<div id="other-input" class="input-box" style="display: none;">
  ...
  <input type="text" name="others" id="other-incident" placeholder="Please specify other incident">
          ...
          <div class="input-box">
            ...
            <input type="text" name="victim_names" id="no_victim_patient" placeholder="Enter the Name of victim/patient" required>
          </div>
...
<script>
  var subIncidentLists = {
    ...
    'Trauma': ['Self Accident', 'Vehicle Accident', 'Drowning', 'Others'],
  };
  ...
  function incidentChange(selectObj) {
    ...
    if (subIncidentSelect.value === 'Others') {
