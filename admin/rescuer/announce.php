...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <section>
                <h3 class="section-head">Alerts</h3>
                ...
                <div class="contents  mt-1">
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <td>
                                    ...
                                    <button type="submit" name="delete"><a href="announce_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to delete this alert?')"><span class="las la-trash"></a></button>
