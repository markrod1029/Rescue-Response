...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `sub_admin`(`name`, `position`, `contact`, `username`, `password`, `photo`) VALUES ('$name','$position','$contact','$username','$password','$images')";

    $conn->query($sql) or die($conn->error);

    echo header("Location: rescuer.php");
}
?>
...
<body>
    ...
    <div class="main-content">
       ...
       <main>
        <section>
        <div class="container">
  <button class="back"><a href="rescuer.php" class="text-white">Back</a></button>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="contact"  minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  data-mdb-input-mask="+63 0000-000-0000" placeholder="Phone Number"  required> 
