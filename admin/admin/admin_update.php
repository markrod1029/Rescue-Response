...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE admins SET fullname = '$fullname', position = '$position', contact = '$contact', username = '$username', password = '$password', photo = '$images' WHERE id='$id'";
    ...
    <div class="content">
      <form action="" method="post"  enctype="multipart/form-data">
        ...
        <div class="input-box">
            ...
            <input type="text" name="fullname" id="fullname" placeholder="Full Name" value="<?php echo $row['fullname'];?>">
          </div>
          <div class="input-box">
            <span class="details">Position</span>
            <input type="text" name="position" id="position" placeholder="Position" value="<?php echo $row['position'];?>">
          </div>
          <div class="input-box">
            <span class="details">Contact Number</span>
            <input type="text" name="contact" id="contact"  minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  data-mdb-input-mask="+63 0000-000-0000" value="<?php echo $row['contact'];?>"> 
