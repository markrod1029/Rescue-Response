    ...
    <div class="main-content">
        ...
        <main>
            <section>
                ...
                <div><button class="btn"><a href="hotline_add.php"><span class="las la-plus"></span>Add</a></button></div>
                <div class="contents  mt-1">
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <td>
                            <button><a href="hotline_update.php?ID=<?php echo $row['id'];?>"><span class="las la-edit"></span></a></button>
                                    <button type="submit" name="delete"><a href="hotline_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to delete this alert?')"><span class="las la-trash"></a></button>
