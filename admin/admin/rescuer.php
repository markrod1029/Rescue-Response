...
<body>
        ...
        <div class="sidebar-container">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="rescuer.php" class="active">
    ...
    <div class="main-content">
        ...
        <main>
            <section>
            <div><button class="btn"><a href="rescuer_add.php"><span class="las la-plus"></span>Add</a></button></div>
                <div class="contents  mt-1">
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                           ...
                           while($row = $query->fetch_assoc()){ ?>
                            ...
                            <td>
                                    <button><a href="rescuer_details.php?ID=<?php echo $row['id'];?>"><span class="las la-eye"></span></a></button>
                                    <button><a href="rescuer_update.php?ID=<?php echo $row['id'];?>"><span class="las la-edit"></span></a></button>
                                    <button type="submit" name="delete"><a href="rescuer_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to delete?')"><span class="las la-trash"></span></a></button>
