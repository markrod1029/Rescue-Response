    ...
    <form action="" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="number" id="number" minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  data-mdb-input-mask="+63 0000-000-0000" value="<?php echo $row['number'];?>"> 
          </div>
          <div class="input-box">
