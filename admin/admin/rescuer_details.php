       ...
       <button class="back"><a href="rescuer.php" class="text-white">Back</a></button>
        <div class="title">Details</div>  
                <div class="card">
                    ...
                    <img src="<?php echo (!empty($row['photo'])) ? '../../img/'.$row['photo'] : '../../img/profile.jpg'; ?>" alt="user" >
                        <div class="card-info">
                            <h3><?php echo $row['name'];?></h3>
                            <h1><?php echo $row['position'];?></h1>
                        </div>
                        <div class="details">
                            <h3>Phone Number: <small><?php echo $row['contact'];?></small></h3>
                        </div>
                        <div class="details">
                            <h3>Username: <small><?php echo $row['username'];?></small></h3>
                        </div>
