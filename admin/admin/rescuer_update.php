    ...
    <form action="" method="post">
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="contact"  minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  data-mdb-input-mask="+63 0000-000-0000" id="contact" value="<?php echo $row['contact'];?>"> 
          </div>
          <div class="input-box">
