...
if(isset($_POST['submit'])){
    ...
    $point_person = htmlspecialchars( $_POST['point_person'], ENT_QUOTES, 'UTF-8');
...
<body>
    ...
    <div class="main-content">
       ...
       <main>
        <section>
        <div class="container">
  <button class="back"><a href="evacuation.php" class="text-white">Back</a></button>
    ...
    <form action="" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="number"  minlength="11" maxlength="11"   pattern="\d{11}" title="11-digit Phone Number"  data-mdb-input-mask="+63 0000-000-0000" placeholder="Phone Number"> 
