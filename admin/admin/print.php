...
<body  >
    ...
    <!-- <div class="main-content"> -->
       ...
       <!-- <main>
       <section> -->
       <!-- <button class="back" style="background:blue;"><a href="report_details.php" class="text-white">Back</a></button> -->
  ...
  <thead>
    <div class="img"><img src="img/scclogo.png" alt="" style="width:11%; height:11%;float:left;position:relative"></div>   
<h6 style="text-align:center;">Republic of the Philippines<br>Province of Pangasinan<br>City of San Carlos</h6>
                ...
                LEFT JOIN users ON users.id=incident_info.user_id ORDER BY incident_info.id DESC";
                $result = $conn->query($view);
                        ...
                        <td><?php echo $row['victim_names'];?></td>
...
<img src="img/scclogo.png" alt="" style="width:13%; height:13%;">
<h5 style="text-align:center;">Republic of the Philippines<br>Province of Pangasinan<br>City of San Carlos</h>
