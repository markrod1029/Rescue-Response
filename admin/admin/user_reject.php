                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="submit" name="delete"><a href="user_confirmed.php?ID=<?php echo $rows['id'];?>" onclick="return confirm('Approved user request?')"><span class="las la-undo-alt"></span></a></button>
