...
<body>
    ...
    <div class="main-content">
       ...
       <section>
       <div class="container">
       <button class="back"><a href="user_approved.php" class="text-white"><i class="las la-arrow-left"></i></a></button>
       ...
       <div class="content">
                <div class="card">
                    ...
                    <img class="img-circle" src="<?php echo (!empty($rows['photo'])) ? '../../img/'.$rows['photo'] : '../../img/profile.jpg'; ?>" alt="user" width="100" height="100">
                        <div class="card-info">
                            <h3><?php echo $rows['fname']." ". $rows['lname'];?></h3>
                            <h1><?php echo $rows['location'];?></h1>
                        </div>
                        <div class="details">
                            <h3>Email: <small><?php echo $rows['user'];?></small></h3>
                        </div>
                        <div class="details">
                            <h3>Contact Number: <small><?php echo $rows['contactnum'];?></small></h3>
                        </div>
                        
                       
                        <div class="card-id">
                            
                        <img src="<?php echo (!empty($rows['valid_id'])) ? '../../img/'.$rows['valid_id'] : '../../img/profile.jpg'; ?>" alt="user">
                        </div>
                    </div>
