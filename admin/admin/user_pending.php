...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <section>
                <h3 class="section-head">Pending</h3>
                <?php
          ...
          $q_r = $conn->query("SELECT COUNT(*) as total FROM users WHERE `status` = 'Archive'") or die(mysqli_error());
  			...
  			?>
                <div class="analytics">
                    ...
                    <div class="analytic"  style="background: #b5ffbb; border: 1px solid #006600">
                        <div class="analytic-icon">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button><a href="user_confirmed.php?ID=<?php echo $rows['id'];?>&&email=<?php echo $rows['user'];?>" onclick="return confirm('Are you sure to approve the request?')"><span class="las la-check"></span></a></button>
                                        <button><a href="user_rejected.php?ID=<?php echo $rows['id'];?>"  onclick="return confirm('Are you sure to Archive the request?')"><span class="las la-file-archive"></span></a></button>
