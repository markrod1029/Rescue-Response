...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <section>
            <h3 class="section-head">Approved</h3>
                <?php
  			...
  			?>
                <div class="analytics">
                    <div class="analytic" style="background: #e9eefd; border: 1px solid #6883db">
                ...
                <div><button class="btn"><a href="user_add.php"><span class="las la-plus"></span>Add</a></button></div>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button><a href="user_update.php?ID=<?php echo $rows['id'];?>"><span class="las la-edit"></span></a></button>
                                        <button><a href="user_rejected.php?ID=<?php echo $rows['id'];?>"  onclick="return confirm('Are you sure to move the user to archive?')"><span class="las la-file-archive"></span></a></button>
